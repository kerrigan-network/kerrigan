...
| -----------------|:------------------------------------------------------------|
| Linux            | `/home/<user>/.kerrigancore/wallets`                             |
| Windows          | `C:\Users\<user>\AppData\Roaming\KerriganCore\wallets`           |
| macOS            | `/Users/<user>/Library/Application Support/KerriganCore/wallets` |
