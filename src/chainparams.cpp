...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsIncreaseBlock = 2100000000; // Effectively never (Kerrigan uses fixed 80/20)
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000cf97d6243cc873e942f96b94380c249aa81b190bccb0d42050bfdee5e59")},
            }
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        // Testnet Kerrigan addresses start with 'y'
