...
::rust::repr::PtrLen sapling$zip32$cxxbridge1$diversifier_index(::std::array<::std::uint8_t, 32> *dk, ::std::array<::std::uint8_t, 11> *d, ::std::array<::std::uint8_t, 11> *return$) noexcept;
...
::rust::repr::PtrLen sapling$tree$cxxbridge1$witness_root(::sapling::tree::SaplingWitness const &wit, ::std::array<::std::uint8_t, 32> *return$) noexcept;

::rust::repr::PtrLen sapling$tree$cxxbridge1$witness_position(::sapling::tree::SaplingWitness const &wit, ::std::uint64_t *return$) noexcept;
...
::std::array<::std::uint8_t, 11> diversifier_index(::std::array<::std::uint8_t, 32> dk, ::std::array<::std::uint8_t, 11> d) {
  ...
  ::rust::repr::PtrLen error$ = sapling$zip32$cxxbridge1$diversifier_index(&dk$.value, &d$.value, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::std::array<::std::uint8_t, 32> witness_root(::sapling::tree::SaplingWitness const &wit) {
  ::rust::MaybeUninit<::std::array<::std::uint8_t, 32>> return$;
  ::rust::repr::PtrLen error$ = sapling$tree$cxxbridge1$witness_root(wit, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
...
::std::uint64_t witness_position(::sapling::tree::SaplingWitness const &wit) {
  ...
  ::rust::repr::PtrLen error$ = sapling$tree$cxxbridge1$witness_position(wit, &return$.value);
  if (error$.ptr) {
    throw ::rust::impl<::rust::Error>::error(error$);
  }
  return ::std::move(return$.value);
