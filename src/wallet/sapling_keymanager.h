...
private:
    ...
    /** Notes currently reserved by an in-flight z_sendmany (#499). */
...
public:
     ...
     * when cs_wallet is released during proof generation (#499).
     */
    ...
    /**
     * Unspent notes with their cmu keys, for reservation tracking (#499).
     */
